...
import { ArrowLeft, Users, Trophy, ChevronRight, Play, X } from "lucide-react";
...
export default function TournamentDetailPage({
  ...
  const { id } = use(params);
  {
    ...
    const {
      ...
      isLoading,
      mutate,
    } = useSWR<Tournament>(`/tournaments/${id}`, fetcher);
    ...
    const canJoin =
      tournament.status === "OPEN" && !isParticipant && !isCreator;

    const canOpen = isCreator && tournament.status === "DRAFT";
